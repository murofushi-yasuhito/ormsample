...
JSON Sample
-------------------------------------
{    "admin_mng_id": 14,    "login_id": "VqXSdShHgyTXUlbYlWGWjmuxZ",    "passwd": "BhYOMzQgMj45KUwvSQ8bNgBdKBo4C1YyYkARCWELDQolMF04Py8=",    "admin_mng_nm": "EiQHJuXydrqrpBqakirUJZLMD",    "admin_mng_auth": "AhfEaGuFwRnKYirRfpeGOcaOw",    "biko": "SRvwKkgBbYpLIsAwxnFVboxps",    "dele_flg": "AUrnaHiVYeNtVWUixkYnmsyju",    "upda_cmnt": "BZWFHQxdOZGKQhkfwgIhOqrnF",    "upda_dte": "2133-11-04T03:07:48.409433768+09:00",    "upda_user_id": 93,    "crea_dte": "2095-07-22T16:06:17.159367174+09:00",    "crea_user_id": 92}



*/

// ADMIN_MNG_MST_ struct is a row record of the ADMIN_MNG_MST table in the anpidb database
type ADMIN_MNG_MST_ struct {
...
func (a *ADMIN_MNG_MST_) TableName() string {
	return "ADMIN_MNG_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *ADMIN_MNG_MST_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *ADMIN_MNG_MST_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *ADMIN_MNG_MST_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *ADMIN_MNG_MST_) TableInfo() *TableInfo {
