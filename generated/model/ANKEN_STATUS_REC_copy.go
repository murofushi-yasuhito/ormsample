...
CREATE TABLE `ANKEN_STATUS_REC_copy` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1100 DEFAULT CHARSET=utf8 COMMENT='案件状態登録'

JSON Sample
-------------------------------------
{    "anken_sts_rec_id": 1,    "anken_id": 65,    "user_id": 8,    "msg_knd": "VidifJYfnuIBtelOHdeaugNlM",    "sts_cd": "ynaPMSRvcjdJbcuvNEWnaqPKX",    "sts_cmnt": "TeYNTQkoYhBVkbxrhqWNHrqPJ",    "msg_ttl": "YQoDajdgJFDKyPoLrAtVTpwAW",    "msg_body": "GQinOoOLDtuvnouOELIfYycsp",    "ans_dte": "2206-07-24T16:09:39.545219976+09:00",    "fami_sts_cd": "hdTLPiDAwmEIxCoRSrgqnVypd",    "qes_1_sts_cd": "svEuxQSCpOwfiyUxPUicGmvnZ",    "qes_2_sts_cd": "jnCrsLwpjgRdBhSNrsAuxKAnE",    "qes_3_sts_cd": "epqLRsZFgNGPAhfZVaWTQFRIx",    "qes_4_sts_cd": "JEuANoahcMxraOEeYWCCTVUJK",    "qes_5_sts_cd": "fmrUgtAiHhhFkrbNTgjkZdfXG",    "agent_user_id": 53,    "agent_user_no": "uuSqKHnlaZGswgKTZqqcCNtZF",    "agent_user_nm": "ENNZTqXFPlsmjsJECuJZVwAwx",    "resp_kbn": "yMHLaLkdYsorViWlulUrOoYXN",    "crea_dte": "2248-06-06T07:04:27.42599973+09:00",    "crea_user_id": 93}



*/

// ANKEN_STATUS_REC_copy struct is a row record of the ANKEN_STATUS_REC_copy table in the anpidb database
type ANKEN_STATUS_REC_copy struct {
...
var ANKEN_STATUS_REC_copyTableInfo = &TableInfo{
	Name: "ANKEN_STATUS_REC_copy",
	Columns: []*ColumnInfo{
...
func (a *ANKEN_STATUS_REC_copy) TableName() string {
	return "ANKEN_STATUS_REC_copy"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *ANKEN_STATUS_REC_copy) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *ANKEN_STATUS_REC_copy) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *ANKEN_STATUS_REC_copy) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *ANKEN_STATUS_REC_copy) TableInfo() *TableInfo {
	return ANKEN_STATUS_REC_copyTableInfo
}
