...
CREATE TABLE `DEFAULT_DLCT_DAY_MST` (
...
JSON Sample
-------------------------------------
{    "default_dlct_id": 89,    "seq": 21,    "deli_day_knd": "rjJNSHojDtIEQltPFiCDagtAY",    "crea_dte": "2285-05-17T11:00:48.522162765+09:00",    "crea_user_id": 94}



*/

// DEFAULT_DLCT_DAY_MST_ struct is a row record of the DEFAULT_DLCT_DAY_MST table in the anpidb database
type DEFAULT_DLCT_DAY_MST_ struct {
...
var DEFAULT_DLCT_DAY_MSTTableInfo = &TableInfo{
	Name: "DEFAULT_DLCT_DAY_MST",
	Columns: []*ColumnInfo{
...
func (d *DEFAULT_DLCT_DAY_MST_) TableName() string {
	return "DEFAULT_DLCT_DAY_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (d *DEFAULT_DLCT_DAY_MST_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (d *DEFAULT_DLCT_DAY_MST_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (d *DEFAULT_DLCT_DAY_MST_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (d *DEFAULT_DLCT_DAY_MST_) TableInfo() *TableInfo {
	return DEFAULT_DLCT_DAY_MSTTableInfo
}
