...
) ENGINE=InnoDB AUTO_INCREMENT=784270 DEFAULT CHARSET=utf8

JSON Sample
-------------------------------------
{    "dept_id": 81,    "dept_cd": "SaTHViOLDosCenARwjOTomIUq",    "client_id": 46,    "top_dept_id": 24,    "up_dept_id": 85,    "dept_pos": 56,    "dept_nm": "swfloCPNjUajRsbbAGBytOEdt",    "pref_cd": "yAVfCkSKPinOgbIPUTaPvEvfI",    "city_cd": "ObXDcPpQTEwGtAkXpingysVKN",    "disp_dsq": 97,    "disp_dsq_sub_no": 79,    "skip_flg": "ciGithlwRafQXEKsVNVrPDIrW",    "batch_flg": "GoobkfOQSTWItVZTCXyAVHAqD",    "auto_start_flg": "PZObnlMpFMindypfbyLBjBHrF",    "upda_dte": "2236-08-15T20:10:53.240630589+09:00",    "upda_user_id": 60,    "crea_dte": "2269-12-04T20:12:21.883699961+09:00",    "crea_user_id": 23}



*/

// DEPT_MST_ struct is a row record of the DEPT_MST table in the anpidb database
type DEPT_MST_ struct {
...
func (d *DEPT_MST_) TableName() string {
	return "DEPT_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (d *DEPT_MST_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (d *DEPT_MST_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (d *DEPT_MST_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (d *DEPT_MST_) TableInfo() *TableInfo {
