...
JSON Sample
-------------------------------------
{    "auth_kbn": 28,    "auth_nm": "CAEgMNTRvGpAAWLfwyrbSmYXW",    "upda_dte": "2244-03-08T20:55:09.512673556+09:00",    "upda_user_id": 72,    "crea_dte": "2150-06-19T21:40:52.063733323+09:00",    "crea_user_id": 19}



*/

// AUTH_MST_ struct is a row record of the AUTH_MST table in the anpidb database
type AUTH_MST_ struct {
...
func (a *AUTH_MST_) TableName() string {
	return "AUTH_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *AUTH_MST_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *AUTH_MST_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *AUTH_MST_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *AUTH_MST_) TableInfo() *TableInfo {
