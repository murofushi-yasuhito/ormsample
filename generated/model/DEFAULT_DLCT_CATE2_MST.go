...
CREATE TABLE `DEFAULT_DLCT_CATE2_MST` (
  `DEFAULT_DLCT_ID` int(11) NOT NULL COMMENT 'ユーザDLCT_ID',
  ...
  PRIMARY KEY (`DEFAULT_DLCT_ID`,`SEQ`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ユーザDLCTカテゴリ2マスタ'

JSON Sample
-------------------------------------
{    "default_dlct_id": 58,    "seq": 45,    "cate_2_cd": "icNvxnctXgajBJtijvcUJcmtT",    "level_value": 57,    "level_kbn": "LZSrHdeDDJGMuYAsaccslypGB",    "level_id": 80,    "crea_dte": "2112-12-10T07:54:44.745963336+09:00",    "crea_user_id": 34}



*/

// DEFAULT_DLCT_CATE2_MST_ struct is a row record of the DEFAULT_DLCT_CATE2_MST table in the anpidb database
type DEFAULT_DLCT_CATE2_MST_ struct {
	//[ 0] DEFAULT_DLCT_ID                                int                  null: false  primary: true   isArray: false  auto: false  col: int             len: -1      default: []
	DEFAULTDLCTID int32 `gorm:"primary_key;column:DEFAULT_DLCT_ID;type:int;"` // ユーザDLCT_ID
...
var DEFAULT_DLCT_CATE2_MSTTableInfo = &TableInfo{
	Name: "DEFAULT_DLCT_CATE2_MST",
	Columns: []*ColumnInfo{
...
func (d *DEFAULT_DLCT_CATE2_MST_) TableName() string {
	return "DEFAULT_DLCT_CATE2_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (d *DEFAULT_DLCT_CATE2_MST_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (d *DEFAULT_DLCT_CATE2_MST_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (d *DEFAULT_DLCT_CATE2_MST_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (d *DEFAULT_DLCT_CATE2_MST_) TableInfo() *TableInfo {
	return DEFAULT_DLCT_CATE2_MSTTableInfo
}
