...
CREATE TABLE `CONT_DELI_HIS` (
  ...
  PRIMARY KEY (`SID`),
  KEY `CONT_DELI_HIS_IDX_1` (`PROC_FLG`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='コンテンツ配信処理履歴'

JSON Sample
-------------------------------------
{    "sid": 14,    "proc_flg": "CUFZtEJIWdcgyLcpejqewMrtP",    "upda_dte": "2116-05-04T05:31:28.063110859+09:00",    "upda_user_id": 90,    "crea_dte": "2041-08-18T21:51:04.442996035+09:00",    "crea_user_id": 28}



*/

// CONT_DELI_HIS_ struct is a row record of the CONT_DELI_HIS table in the anpidb database
type CONT_DELI_HIS_ struct {
...
var CONT_DELI_HISTableInfo = &TableInfo{
	Name: "CONT_DELI_HIS",
	Columns: []*ColumnInfo{
...
func (c *CONT_DELI_HIS_) TableName() string {
	return "CONT_DELI_HIS"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (c *CONT_DELI_HIS_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (c *CONT_DELI_HIS_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (c *CONT_DELI_HIS_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (c *CONT_DELI_HIS_) TableInfo() *TableInfo {
	return CONT_DELI_HISTableInfo
}
