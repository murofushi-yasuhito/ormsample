...
CREATE TABLE `ANPI_USER_AREA_MST` (
...
) ENGINE=InnoDB AUTO_INCREMENT=81302411 DEFAULT CHARSET=utf8 COMMENT='安否起動ユーザエリアマスタ'

JSON Sample
-------------------------------------
{    "anpi_user_area_id": 57,    "anpi_dlct_id": 72,    "user_id": 86,    "area_kbn": "KpSQnVvxseAYHyAWDuVrgVyLJ",    "area_cd_1": "ebEFMmAdaBUNPIIXUrlhqAEwU",    "area_cd_2": "ErwEQLnsLPupiYkQVWgbeBYMv",    "area_cd_3": "GFNkkqCOiBufqWyOJfkdpKniK",    "area_cd_4": "PHqoHxnAdcZDyjwCwubKVsgdS",    "area_cd_5": "uckenPcZxymneFQYSEahvmXok",    "weth_area_cd_1": "AKejcDsMGaMOPNrFPRRnArBtX",    "weth_area_cd_2": "kArXoZrUjqGXymmlWbLiFVYqc",    "weth_area_cd_3": "ceMERVTxYhuIDXrdeeZESKPJv",    "dele_flg": "EwcyUOpxWMEpKvURHhysTNdOF",    "start_grp_id": 9,    "crea_dte": "2053-11-04T16:55:59.948116736+09:00",    "crea_user_id": 79}



*/

// ANPI_USER_AREA_MST_ struct is a row record of the ANPI_USER_AREA_MST table in the anpidb database
type ANPI_USER_AREA_MST_ struct {
...
var ANPI_USER_AREA_MSTTableInfo = &TableInfo{
	Name: "ANPI_USER_AREA_MST",
	Columns: []*ColumnInfo{
...
func (a *ANPI_USER_AREA_MST_) TableName() string {
	return "ANPI_USER_AREA_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *ANPI_USER_AREA_MST_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *ANPI_USER_AREA_MST_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *ANPI_USER_AREA_MST_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *ANPI_USER_AREA_MST_) TableInfo() *TableInfo {
	return ANPI_USER_AREA_MSTTableInfo
}
