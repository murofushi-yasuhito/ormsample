...
JSON Sample
-------------------------------------
{    "admin_grp_id": 76,    "admin_grp_seq": 79,    "user_id": 59,    "dept_auth_kbn": 92,    "dept_start_mail_flg": "aASYAdswUMEImKcuvfRJjALQU",    "client_id": 40,    "upda_dte": "2135-11-21T07:37:14.458212711+09:00",    "upda_user_id": 20,    "crea_dte": "2145-03-06T06:42:27.196274717+09:00",    "crea_user_id": 70}



*/

// ADMIN_GRP_DTL_MST_ struct is a row record of the ADMIN_GRP_DTL_MST table in the anpidb database
type ADMIN_GRP_DTL_MST_ struct {
...
func (a *ADMIN_GRP_DTL_MST_) TableName() string {
	return "ADMIN_GRP_DTL_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *ADMIN_GRP_DTL_MST_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *ADMIN_GRP_DTL_MST_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *ADMIN_GRP_DTL_MST_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *ADMIN_GRP_DTL_MST_) TableInfo() *TableInfo {
