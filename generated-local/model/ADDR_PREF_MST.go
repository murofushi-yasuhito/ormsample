...
JSON Sample
-------------------------------------
{    "pref_cd": "dPDTAqeXtQKfWFYeXIAmViTGn",    "pref_nm": "ZcJZwxVHVHOqbdxKyeSePmYCx",    "pref_nmc": "tIIFHixLPPXiJSwQcQjgbyMCy",    "addr_area_cd": "TjPhKyqEWiRlProqArwFiZspf",    "rail_area_cd": "SVKQsMalsgZeZeqOLODsfoKcn",    "dele_flg": "AkZigoFDqtngnLQPuScnoDdMe",    "upda_dte": "2131-06-24T22:12:58.457313175+09:00",    "upda_user_cd": "kiGfnYkBLLWOwKFZWTRFaiePX",    "crea_dte": "2032-07-13T15:16:24.820277951+09:00",    "crea_user_cd": "vYOIOrLyDIsKhHoZTHOKknEYC"}



*/

// ADDR_PREF_MST struct is a row record of the ADDR_PREF_MST table in the anpidb database
type ADDR_PREF_MST struct {
...
func (a *ADDR_PREF_MST) TableName() string {
	return "ADDR_PREF_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *ADDR_PREF_MST) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *ADDR_PREF_MST) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *ADDR_PREF_MST) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *ADDR_PREF_MST) TableInfo() *TableInfo {
