...
JSON Sample
-------------------------------------
{    "auth_kbn": 96,    "inn_auth_kbn": 26,    "upda_dte": "2203-12-19T16:03:14.04823691+09:00",    "upda_user_id": 36,    "crea_dte": "2204-01-28T19:01:22.364396686+09:00",    "crea_user_id": 72}



*/

// AUTH_DTL_MST struct is a row record of the AUTH_DTL_MST table in the anpidb database
type AUTH_DTL_MST struct {
...
func (a *AUTH_DTL_MST) TableName() string {
	return "AUTH_DTL_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *AUTH_DTL_MST) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *AUTH_DTL_MST) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *AUTH_DTL_MST) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *AUTH_DTL_MST) TableInfo() *TableInfo {
