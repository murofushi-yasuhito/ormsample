...
) ENGINE=InnoDB AUTO_INCREMENT=36328 DEFAULT CHARSET=utf8

JSON Sample
-------------------------------------
{    "admin_grp_id": 90,    "client_id": 39,    "dept_id": 98,    "batch_flg": "PsTKvSakoLVuwUZNyDRVxiggW",    "upda_dte": "2291-10-24T03:17:37.172782855+09:00",    "upda_user_id": 30,    "crea_dte": "2071-07-16T23:56:10.540008188+09:00",    "crea_user_id": 9}



*/

// ADMIN_GRP_MST struct is a row record of the ADMIN_GRP_MST table in the anpidb database
type ADMIN_GRP_MST struct {
...
func (a *ADMIN_GRP_MST) TableName() string {
	return "ADMIN_GRP_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *ADMIN_GRP_MST) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *ADMIN_GRP_MST) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *ADMIN_GRP_MST) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *ADMIN_GRP_MST) TableInfo() *TableInfo {
