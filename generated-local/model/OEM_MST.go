...
JSON Sample
-------------------------------------
{    "oem_id": 30,    "oem_nm": "lWcgUCFCmZsLJVvWybitTEtJh",    "domain_nm": "jNkeJimByNwogMLOaJAQuHHbN",    "head_txt": "WusIiyYlWrrauSweAcVYRKyEM",    "head_logo_file": "TbujpVmsgQxqqrxpNnuacycrB",    "foot_txt": "uTxFJTxyCfRhCHfwyubkwXmfY",    "foot_logo_file": "GkmYNDycGUYlZQKWBkqOQeOij",    "contract_disp_kbn": "mPESimmIBxZMBWOWXJyUJXEHd",    "support_disp_kbn": "biAnvovooKLBboNaNtWnZkIki",    "biko": "oOGFujQpJOAioZNjIMnwYJpXp",    "upda_cmnt": "vorvunQMsVisNpgpHnpuWYrOx",    "dele_flg": "jiZErtvbXXAIjtboiZoBLPsOA",    "upda_dte": "2049-08-08T09:16:15.664771468+09:00",    "upda_user_id": 11,    "crea_dte": "2235-05-14T18:24:45.958986766+09:00",    "crea_user_id": 84}



*/

// OEM_MST struct is a row record of the OEM_MST table in the anpidb database
type OEM_MST struct {
...
func (o *OEM_MST) TableName() string {
	return "OEM_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (o *OEM_MST) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (o *OEM_MST) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (o *OEM_MST) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (o *OEM_MST) TableInfo() *TableInfo {
