...
JSON Sample
-------------------------------------
{    "city_cd": "yXRuqPJEVGuXlNJvlxmBScWcU",    "city_nmj": "jnnWpDnKuMlpFQIjJjYGGicLi",    "city_nmc": "EGhstQWaUHWvduwnXyUXuCndO",    "pref_cd": "SAsFJQPCJFosESveMMReFTCnB",    "dele_flg": "JoUPnpgdNsibfNtJXSxZYBPia",    "upda_dte": "2185-08-25T18:12:29.968090237+09:00",    "upda_user_cd": "nDhftjKQuSOPcwxhHyLMMXXra",    "crea_dte": "2278-01-13T15:34:48.567362525+09:00",    "crea_user_cd": "yowglkRpVWXeUUUyNWlYkNDVq"}



*/

// ADDR_CITY_MST struct is a row record of the ADDR_CITY_MST table in the anpidb database
type ADDR_CITY_MST struct {
...
func (a *ADDR_CITY_MST) TableName() string {
	return "ADDR_CITY_MST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *ADDR_CITY_MST) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *ADDR_CITY_MST) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *ADDR_CITY_MST) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *ADDR_CITY_MST) TableInfo() *TableInfo {
